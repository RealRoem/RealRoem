...
- 🧠 Focus: Frontend, software architecture, data engineering  
- 🚀 Current: .NET SaaS web solution for small businesses  
- 🌱 Learning: React Native, R, Assembly  
...
### Tools
- Git & GitHub
- Adobe: Photoshop, Premiere Pro, Audition, Lightroom
- OBS
